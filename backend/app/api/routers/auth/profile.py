...
def get_current_user_info(
    ...
    try:
        ...
        return {
            ...
            "subscription_canceled_at": current_user.subscription_canceled_at.isoformat() if current_user.subscription_canceled_at else None,
            "is_premium": current_user.is_premium,  # Computed property
