...
export const Button = ({
  ...
  const baseClasses =
    "tap-target flex items-center justify-center font-semibold rounded-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed btn-hover touch-manipulation";
  ...
  const sizes = {
    sm: "px-3 py-2 text-sm min-h-[40px]", // Increased minimum touch target size
    md: "px-4 py-2.5 text-sm min-h-[44px]", // 44px is recommended minimum for touch
